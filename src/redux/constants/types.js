...
export const ADD_COMMENT_NOTIFICATION_FROM_SERVER = "ADD_COMMENT_NOTIFICATION_FROM_SERVER";
...
export const LIKE_POST_NOTIFICATION_FROM_SERVER = "LIKE_POST_NOTIFICATION_FROM_SERVER";

// Socket dispatch message to Saga
export const ADD_COMMENT_NOTIFICATION_SAGA = "ADD_COMMENT_NOTIFICATION_SAGA";
export const UPDATE_COMMENT_NOTIFICATION_SAGA = "UPDATE_COMMENT_NOTIFICATION_SAGA";
...
export const SET_IS_VIEW_FRIEND_PROFILE = 'SET_IS_VIEW_FRIEND_PROFILE';
...
export const REDUCER_READED_NOTIFICATION = 'REDUCER_READED_NOTIFICATION';
